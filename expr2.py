...
#Main 
precedence = ( ('left','DEPOP'), ('left','EDEPOP'))
...
def p_prop(t):
    ...
    if len(t)==2:
        if t[1].startswith('"'):
            ...
            t[0]=(u"TXT_TAG",unicode(t[1]))
    elif len(t)==3:
        t[0]=(unicode(t[1][1:]),unicode(t[2][1:-1])) #strip the /../

def p_prop2(t):
    u'''prop : PLUS WORD_TAG'''
    t[0]=(u"TXT_TAG",unicode(t[2]))

def p_prop3(t):
    u'''prop : PLUS PARENTHESIS'''
    t[0]=(u"TXT",unicode(t[2][1:-1]))
...
if __name__=="__main__":
    ...
    for expression in args.expression:
        ...
        ###
        print expression
        ready_node = e_parser.parse(expression)
        print ready_node.to_unicode()
