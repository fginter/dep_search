...
if __name__=="__main__":
    ...
    parser.add_argument('--url', default="http://bionlp-www.utu.fi/dep_search_api", help='The base URL of the service to query')
    parser.add_argument('-d', '--db', required=True, help='The treebank to use.')
